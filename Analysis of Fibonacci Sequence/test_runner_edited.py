"""
This python "script" can be ran to help collect 
...
python3 test_runner.py 30 > fibonnaci_table.md
"""
...
COMMON_ARG_FORMAT = "./fib_c {n} {algo} 0"
FORMAT = "markdown"
TIMEOUT = 60
COMMON_ARG_PYTHON = "python3 fib_python.py --algo {algo} {n}"  # using pypy3 as it is faster than python
